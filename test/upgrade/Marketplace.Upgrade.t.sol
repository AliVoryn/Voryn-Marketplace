...
import "../../src/proxy/interfaces/IUpgradeableSystem.sol";
...
contract MarketplaceUpgradeTest is ProtocolTestBase {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeCall(Marketplace.initialize, (admin, address(treasury), address(paymentManager)));
    ...
    function test_Upgrade_EmitsUpgradedByProtocolEvent() public {
        ...
        emit IUpgradeableSystem.UpgradedByProtocol(address(implV2), admin);
        marketplace.upgradeToAndCall(address(implV2), "");
    }
}
